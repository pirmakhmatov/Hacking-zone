...
import { ArrowLeft, Play, BookOpen, Search, Zap, CheckCircle, Clock, Users, Target, Download, MessageCircle, Star, Bookmark, Share2, FileText, Award, Video, Code, FileDigit, Calendar, User, Save, Trash2, Cpu, Binary, Key, Sparkles, Shield, Fingerprint, Database, HardDrive } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import jsPDF from "jspdf";

export default function DigitalForensics() {
  const [currentVideo, setCurrentVideo] = useState("w2xItujdLag");
  ...
  // Real downloadable files for Digital Forensics
  const resources = [
    { 
      name: "Digital Forensics Methodology", 
      type: "PDF", 
      size: "3.8 MB", 
      icon: FileText, 
      downloads: 1280,
      fileUrl: "/downloads/digital-forensics/Digital-Forensics-Methodology.pdf",
      description: "Complete digital forensics investigation methodology and procedures"
    },
    { 
      name: "Forensics Tools Collection", 
      type: "ZIP", 
      size: "25.3 MB", 
      icon: Download, 
      downloads: 1560,
      fileUrl: "/downloads/digital-forensics/Forensics-Tools-Collection.zip",
      description: "Essential digital forensics tools and software packages"
    },
    { 
      ...
      icon: Database, 
      downloads: 980,
      fileUrl: "/downloads/digital-forensics/Memory-Forensics-Guide.pdf",
      description: "Complete guide to RAM analysis and memory forensics techniques"
    },
    { 
      name: "Network Forensics Handbook", 
      type: "PDF", 
      size: "3.1 MB", 
      icon: Shield, 
      downloads: 1120,
      fileUrl: "/downloads/digital-forensics/Network-Forensics-Handbook.pdf",
      description: "Network traffic analysis and network-based forensics"
    },
    { 
      ...
      icon: Fingerprint, 
      downloads: 1340,
      fileUrl: "/downloads/digital-forensics/Mobile-Device-Forensics.pdf",
      description: "Smartphone and mobile device forensic analysis techniques"
    },
    { 
      name: "Forensic Imaging Templates", 
      type: "ZIP", 
      size: "8.7 MB", 
      icon: HardDrive, 
      downloads: 890,
      fileUrl: "/downloads/digital-forensics/Forensic-Imaging-Templates.zip",
      description: "Disk imaging and evidence preservation templates"
    }
  ];
  ...
  const lessons = [
    {
      ...
      description: "Learn the basics of digital evidence, chain of custody, and forensic principles",
      duration: "25 min",
      completed: true,
      type: "video",
      youtubeId: "w2xItujdLag",
      resources: ["Evidence Handling Guide", "Chain of Custody Forms"]
    },
    {
      id: 2,
      title: "Disk Imaging & Data Acquisition",
      description: "Master disk imaging techniques and data acquisition methods for evidence preservation",
      duration: "35 min",
      completed: true,
      type: "interactive",
      youtubeId: "7eT8KSHMGFw",
      resources: ["Imaging Tools Guide", "Data Recovery Scripts"]
    },
    {
      id: 3,
      title: "File System Forensics",
      description: "Analyze NTFS, FAT, EXT file systems and recover deleted files and metadata",
      duration: "40 min",
      completed: false,
      type: "video",
      youtubeId: "0Yf-W7Ps6u4",
      resources: ["File System Reference", "Metadata Analysis Tools"]
    },
    {
      id: 4,
      title: "Memory Forensics & RAM Analysis",
      description: "Extract and analyze volatile memory for evidence of running processes and malware",
      duration: "45 min",
      completed: false,
      type: "interactive",
      youtubeId: "34hF8tWkATU",
      resources: ["Memory Analysis Tools", "Volatility Framework"]
    },
    {
      id: 5,
      title: "Network Forensics",
      description: "Capture and analyze network traffic, investigate network-based attacks and intrusions",
      duration: "38 min",
      completed: false,
      type: "video",
      youtubeId: "4TycDUt_ayc",
      resources: ["Packet Analysis Guide", "Network Investigation Tools"]
    },
    {
      id: 6,
      title: "Mobile Device Forensics",
      description: "Extract evidence from smartphones, tablets, and mobile applications",
      duration: "42 min",
      completed: false,
      type: "interactive",
      youtubeId: "uZxb_pTAELg",
      resources: ["Mobile Extraction Tools", "App Data Analysis"]
    }
  ];

  const achievements = [
    { id: 1, name: "Evidence Handler", description: "Complete forensics fundamentals", earned: true, icon: Search },
    { id: 2, name: "Disk Imager", description: "Master disk imaging techniques", earned: true, icon: HardDrive },
    { id: 3, name: "File System Analyst", description: "Understand file system forensics", earned: false, icon: Database },
    { id: 4, name: "Memory Expert", description: "Master memory forensics", earned: false, icon: Cpu },
    { id: 5, name: "Network Investigator", description: "Complete network forensics", earned: false, icon: Shield },
    { id: 6, name: "Forensics Professional", description: "Complete all course modules", earned: false, icon: Award }
  ];
  ...
  const handleDownloadAll = () => {
    try {
      const bundlePath = "/downloads/digital-forensics/hacking_zone_digital_forensics.zip";
      const link = document.createElement('a');
      ...
      alert('Unable to start bundle download. Make sure hacking_zone_digital_forensics.zip exists in /public/downloads/');
    }
  };
  ...
  // Certificate Generation for Digital Forensics
  const generateCertificate = () => {
    ...
    pdf.setFillColor(168, 85, 247); // Purple theme
    ...
    pdf.setFont(undefined, 'bold');
    const certNumber = 'CSA-DF' + Array.from({length: 8}, () => 
    ...
    pdf.setTextColor(0, 0, 0);
    pdf.setFont(undefined, 'bold');
    pdf.text('Digital Forensics Specialist', pageWidth / 2, 100, { align: 'center' });
    ...
    const achievementLines = [
        ...
        'Digital Forensics Specialist certification through examination'
    ];
    ...
    pdf.setTextColor(168, 85, 247);
    pdf.setFont(undefined, 'bold');
    pdf.text('Digital Forensics & Investigation', pageWidth / 2, 225, { align: 'center' });
    ...
    pdf.text('DIGITAL FORENSICS SPECIALIZATION', pageWidth / 2, accreditationY + 6, { align: 'center' });
    ...
    const fileName = `DigitalForensics_Certificate_${userData.firstName}_${userData.lastName}.pdf`;
    pdf.save(fileName);
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 flex-1">
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <h1 className="text-2xl md:text-4xl font-bold text-white mb-1">Digital Forensics</h1>
                  <p className="text-purple-400 text-sm md:text-lg">Master evidence collection and analysis</p>
                </div>
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-purple-500/30"
              ...
              <div className="mt-3 md:mt-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
                  <h2 className="text-lg md:text-xl font-semibold text-white">Digital Evidence Investigation</h2>
                  <div className="flex items-center gap-2">
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Learn professional digital forensics techniques for evidence collection, preservation, and analysis. 
                  Master disk imaging, memory forensics, network analysis, and mobile device investigation methods used by law enforcement and security professionals.
                </p>
              </div>
            </motion.div>
              ...
              <motion.div className="space-y-4"
                ...
                <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
                  ...
                  <p className="text-gray-400 text-sm md:text-base mb-3 md:mb-4">
                    This comprehensive digital forensics course covers the complete investigation process from evidence acquisition to courtroom presentation. 
                    Learn to use professional tools and techniques to uncover digital evidence and support legal proceedings.
                  </p>
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              placeholder="Take notes about evidence handling, forensic tools, investigation techniques..."
              ...
              <div className="space-y-4">
                ...
                <motion.button
                  ...
                  className={`w-full py-2 md:py-3 font-bold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 text-sm md:text-base ${
                    progress >= 100
                      ? "bg-gradient-to-r from-green-500 to-purple-500 text-white hover:from-green-600 hover:to-purple-600 shadow-lg shadow-green-500/25"
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div className="flex justify-between">
                  ...
                  <span className="text-purple-400">Detective Maria Rodriguez</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span>Category:</span>
                  <span className="text-pink-400">Digital Investigation</span>
                </div>
                <div className="flex justify-between">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                🎓 Generate your professional Digital Forensics certificate with official design, 
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-green-500 to-purple-500 text-white font-bold rounded-lg hover:from-green-600 hover:to-purple-600 transition-all duration-300 shadow-lg shadow-green-500/25 flex items-center justify-center gap-3"
                >
