...
import { ArrowLeft, Play, BookOpen, Terminal, Zap, CheckCircle, Clock, Users, Target, Download, MessageCircle, Star, Bookmark, Share2, FileText, Award, Video, Code, FileDigit, Calendar, User, Save, Trash2, Cpu, Binary, Key, Lock, Sparkles, Shield, Server, Search } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import jsPDF from "jspdf";

export default function LinuxEthicalHacking() {
  const [currentVideo, setCurrentVideo] = useState("VbEx7B_PTOE");
  ...
  // Real downloadable files for Linux Ethical Hacking
  const resources = [
    { 
      ...
      icon: FileText, 
      downloads: 1890,
      fileUrl: "/downloads/linux-hacking/Linux-Command-Line-Mastery.pdf",
      description: "Complete Linux command reference for penetration testers"
    },
    { 
      name: "Bash Scripting for Hackers", 
      type: "PDF", 
      size: "3.2 MB", 
      icon: Code, 
      downloads: 1450,
      fileUrl: "/downloads/linux-hacking/Bash-Scripting-for-Hackers.pdf",
      description: "Advanced bash scripting techniques for security professionals"
    },
    { 
      name: "Linux Privilege Escalation Guide", 
      type: "PDF", 
      size: "4.1 MB", 
      icon: Shield, 
      downloads: 2100,
      fileUrl: "/downloads/linux-hacking/Linux-Privilege-Escalation-Guide.pdf",
      description: "Comprehensive privilege escalation methods and techniques"
    },
    { 
      name: "Linux Security Tools Collection", 
      type: "ZIP", 
      size: "18.5 MB", 
      icon: Download, 
      downloads: 980,
      fileUrl: "/downloads/linux-hacking/Linux-Security-Tools-Collection.zip",
      description: "Essential Linux security and penetration testing tools"
    },
    { 
      name: "Kali Linux Customization Guide", 
      type: "PDF", 
      size: "2.5 MB", 
      icon: Terminal, 
      downloads: 1250,
      fileUrl: "/downloads/linux-hacking/Kali-Linux-Customization-Guide.pdf",
      description: "Customizing Kali Linux for optimal penetration testing"
    },
    { 
      name: "Linux Forensics & Incident Response", 
      type: "PDF", 
      size: "3.8 MB", 
      icon: Search, 
      downloads: 890,
      description: "Digital forensics and incident response on Linux systems",
    },
  ];
  ...
  const lessons = [
    {
      ...
      description: "Master essential Linux commands, file systems, and terminal navigation for ethical hacking",
      duration: "25 min",
      completed: true,
      type: "video",
      youtubeId: "VbEx7B_PTOE",
      resources: ["Command Cheat Sheet", "Practice Exercises"]
    },
    {
      id: 2,
      title: "Bash Scripting & Automation",
      description: "Create powerful automation scripts for penetration testing and security assessments",
      duration: "30 min",
      completed: true,
      type: "interactive",
      youtubeId: "PPQ8m8xQAs8",
      resources: ["Script Templates", "Automation Tools"]
    },
    {
      id: 3,
      title: "User & Permission Management",
      description: "Understand Linux user management, file permissions, and access control mechanisms",
      duration: "28 min",
      completed: false,
      type: "video",
      youtubeId: "19WOD84JFxA",
      resources: ["Permission Reference", "Access Control Lists"]
    },
    {
      id: 4,
      title: "Linux Privilege Escalation",
      description: '1/: "Learn systematic privilege escalation techniques from user to root access' ,
      duration: "45 min",
      completed: false,
      type: "interactive",
      youtubeId: "ZTnwg3qCdVM",
      resources: ["Escalation Checklist", "Exploit Database"]
    },
    {
      id: 5,
      title: "Process & Service Management",
      description: "Master process monitoring, service management, and system daemon exploitation",
      duration: "35 min",
      completed: false,
      type: "video",
      youtubeId: "LfC6pv8VISk",
      resources: ["Service Scripts", "Process Monitoring Tools"]
    },
    {
      id: 6,
      title: "Linux Network Security",
      description: "Configure firewalls, monitor network traffic, and secure Linux network services",
      duration: "40 min",
      completed: false,
      type: "interactive",
      youtubeId: "pKawETTKDww",
      resources: ["Firewall Rules", "Network Hardening Guide"]
    }
  ];

  const achievements = [
    { id: 1, name: "Terminal Master", description: "Complete Linux fundamentals", earned: true, icon: Terminal },
    { id: 2, name: "Script Ninja", description: "Master bash scripting", earned: true, icon: Code },
    { id: 3, name: "Permission Expert", description: "Understand Linux permissions", earned: false, icon: Shield },
    { id: 4, name: "Privilege Escalator", description: "Master privilege escalation", earned: false, icon: Zap },
    { id: 5, name: "Process Hunter", description: "Complete process management", earned: false, icon: Cpu },
    { id: 6, name: "Linux Security Pro", description: "Complete all course modules", earned: false, icon: Award }
  ];
  ...
  const handleDownloadAll = () => {
    try {
      const bundlePath = "/downloads/linux-hacking/hacking_zone_linux_hacking.zip";
      const link = document.createElement('a');
      ...
      alert('Unable to start bundle download. Make sure hacking_zone_linux_hacking.zip exists in /public/downloads/');
    }
  };
  ...
  // Certificate Generation for Linux Ethical Hacking
  const generateCertificate = () => {
    ...
    pdf.setFillColor(34, 197, 94); // Green theme
    ...
    pdf.setFont(undefined, 'bold');
    const certNumber = 'CSA-LH' + Array.from({length: 8}, () => 
    ...
    pdf.setTextColor(0, 0, 0);
    pdf.setFont(undefined, 'bold');
    pdf.text('Linux Ethical Hacking Specialist', pageWidth / 2, 100, { align: 'center' });
    ...
    const achievementLines = [
        ...
        'Linux Ethical Hacking Specialist certification through examination'
    ];
    ...
    pdf.setTextColor(34, 197, 94);
    pdf.setFont(undefined, 'bold');
    pdf.text('Linux Ethical Hacking', pageWidth / 2, 225, { align: 'center' });
    ...
    pdf.text('LINUX SECURITY SPECIALIZATION', pageWidth / 2, accreditationY + 6, { align: 'center' });
    ...
    const fileName = `LinuxEthicalHacking_Certificate_${userData.firstName}_${userData.lastName}.pdf`;
    pdf.save(fileName);
    ...
    <div className="min-h-screen py-4 md:py-8 px-3 md:px-4 pt-20 md:pt-24">
      ...
      <motion.div className="max-w-7xl mx-auto relative z-10"
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6 md:mb-8">
          <Link to="/learning" className="glass card-cyber p-2 md:p-3 border border-green-500/30 hover:border-green-500/50 transition-colors self-start">
            <ArrowLeft className="w-4 h-4 md:w-5 md:h-5 text-green-400" />
          </Link>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 flex-1">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg md:rounded-xl flex items-center justify-center">
              <Terminal className="w-6 h-6 md:w-8 md:h-8 text-white" />
            </div>
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <h1 className="text-2xl md:text-4xl font-bold text-white mb-1">Linux Ethical Hacking</h1>
                  <p className="text-green-400 text-sm md:text-lg">Master Linux for penetration testing</p>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <motion.button
                    ...
                    className="glass p-2 border border-gray-700/50 rounded-lg text-gray-400 hover:text-green-400 transition-colors"
                  >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 md:gap-8">
          ...
          <div className="xl:col-span-3 space-y-4 md:space-y-6">
            {/* Video Player */}
            <motion.div className="glass card-cyber p-4 md:p-6 border border-green-500/30"
              ...
              <div className="aspect-video bg-black rounded-lg overflow-hidden relative">
                <iframe
                  ...
                  title="Linux Ethical Hacking Course"
                  frameBorder="0"
              ...
              <div className="mt-3 md:mt-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
                  <h2 className="text-lg md:text-xl font-semibold text-white">Linux Security Fundamentals</h2>
                  <div className="flex items-center gap-2">
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Master Linux command line, bash scripting, privilege escalation, and security tools essential for ethical hacking and penetration testing. 
                  Learn to navigate, exploit, and secure Linux systems like a professional security researcher.
                </p>
              </div>
            </motion.div>
              ...
              <motion.div className="space-y-4"
                ...
                <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
                  ...
                  <h3 className="text-base md:text-lg font-semibold text-white mb-3 md:mb-4 flex items-center gap-2">
                    <BookOpen className="w-4 h-4 md:w-5 md:h-5 text-green-400" />
                    Course Overview
                  </h3>
                  <p className="text-gray-400 text-sm md:text-base mb-3 md:mb-4">
                    This comprehensive Linux ethical hacking course covers everything from basic command line operations to advanced privilege escalation techniques. 
                    Learn to use Linux as both an attack platform and understand how to defend Linux systems against common attacks.
                  </p>
                        ...
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex items-start gap-3 flex-1">
                            {lesson.completed ? (
                              ...
                              <div className="w-5 h-5 rounded-full border-2 border-green-400 group-hover:border-green-300 transition-colors mt-0.5 flex-shrink-0"></div>
                            )}
                            <div className="flex-1">
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              placeholder="Take notes about Linux commands, bash scripting, privilege escalation techniques..."
            ...
            {activeTab === "resources" && (
              <motion.div className="glass card-cyber p-4 md:p-6 border border-blue-500/30"
                ...
                <motion.button
                  ...
                  className="w-full mt-4 py-3 bg-gradient-to-r from-blue-500 to-green-500 text-white font-bold rounded-lg hover:from-blue-600 hover:to-green-600 transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                >
          ...
          <div className="xl:col-span-1 space-y-4 md:space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div className="p-2 bg-green-500/10 rounded border border-green-500/20">
                    <div className="text-green-400 font-bold text-lg">{completedLessons}/{totalLessons}</div>
                    <div className="text-gray-400 text-xs">Lessons</div>
                  </div>
                  <div className="p-2 bg-emerald-500/10 rounded border border-emerald-500/20">
                    <div className="text-emerald-400 font-bold text-lg">{resources.length}</div>
                ...
                <button 
                  ...
                  className="w-full py-2 md:py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-300 flex items-center justify-center gap-2 text-sm md:text-base"
                >
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-blue-500/30"
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button 
                  onClick={handleShareCourse}
                  className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg text-green-400 hover:bg-green-500/20 transition-colors text-sm flex flex-col items-center gap-1"
                >
                  <Share2 className="w-4 h-4" />
                  <span>Share</span>
                </button>
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400">Dr. Sarah Johnson</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span>Category:</span>
                  <span className="text-emerald-400">Linux Security</span>
                </div>
                <div className="flex justify-between">
      ...
      {showShareOptions && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <motion.div 
            ...
            className="glass card-cyber p-6 border border-green-500/30 rounded-xl max-w-md w-full"
          >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                🎓 Generate your professional Linux Ethical Hacking certificate with official design, 
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all duration-300 shadow-lg shadow-green-500/25 flex items-center justify-center gap-3"
                >
