...
import { ArrowLeft, Play, BookOpen, Lock, Zap, CheckCircle, Clock, Users, Target, Download, MessageCircle, Star, Bookmark, Share2, FileText, Award, Video, Code, FileDigit, Calendar, User, Save, Trash2, Cpu, Binary, Key, Sparkles, Shield, Hash, FileKey, Fingerprint } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import jsPDF from "jspdf";

export default function Cryptography() {
  const [currentVideo, setCurrentVideo] = useState("VYech-c5Dic");
  ...
  // Real downloadable files for Cryptography
  const resources = [
    { 
      name: "Cryptography Algorithms Guide", 
      type: "PDF", 
      size: "3.2 MB", 
      icon: FileText, 
      downloads: 1450,
      fileUrl: "/downloads/cryptography/Cryptography-Algorithms-Guide.pdf",
      description: "Comprehensive guide to symmetric and asymmetric encryption algorithms"
    },
    { 
      ...
      icon: FileKey, 
      downloads: 980,
      fileUrl: "/downloads/cryptography/Public-Key-Infrastructure-Guide.pdf",
      description: "Complete PKI implementation and management guide"
    },
    { 
      name: "Cryptography Tools Collection", 
      type: "ZIP", 
      size: "12.5 MB", 
      icon: Download, 
      downloads: 1120,
      fileUrl: "/downloads/cryptography/Cryptography-Tools-Collection.zip",
      description: "Essential cryptography tools and libraries for developers"
    },
    { 
      ...
      icon: Hash, 
      downloads: 1670,
      fileUrl: "/downloads/cryptography/Hash-Functions-Digital-Signatures.pdf",
      description: "Advanced hash functions and digital signature implementation"
    },
    { 
      name: "TLS/SSL Protocol Deep Dive", 
      type: "PDF", 
      size: "3.5 MB", 
      icon: Shield, 
      downloads: 1340,
      fileUrl: "/downloads/cryptography/TLS-SSL-Protocol-Deep-Dive.pdf",
      description: "Complete TLS/SSL protocol analysis and implementation"
    },
    { 
      name: "Cryptographic Implementation Templates", 
      type: "ZIP", 
      size: "5.8 MB", 
      icon: Code, 
      downloads: 890,
      fileUrl: "/downloads/cryptography/Cryptographic-Implementation-Templates.zip",
      description: "Code templates for common cryptographic operations"
    }
  ];
  ...
  const lessons = [
    {
      ...
      description: "Learn AES, DES, 3DES and other symmetric encryption algorithms with practical implementations",
      duration: "25 min",
      completed: true,
      type: "video",
      youtubeId: "VYech-c5Dic",
      resources: ["AES Implementation Guide", "Symmetric Key Management"]
    },
    {
      id: 2,
      title: "Asymmetric Cryptography & RSA",
      description: "Master RSA, ECC, Diffie-Hellman and public key infrastructure concepts",
      duration: "30 min",
      completed: true,
      type: "interactive",
      youtubeId: "GSIDS_lvRv4",
      resources: ["RSA Key Generation", "ECC Implementation"]
    },
    {
      id: 3,
      title: "Hash Functions & Digital Signatures",
      description: "Understand SHA, MD5, HMAC and digital signature algorithms with real-world applications",
      duration: "28 min",
      completed: false,
      type: "video",
      youtubeId: "O4xNJsjtN6E",
      resources: ["Hash Collision Analysis", "Signature Verification"]
    },
    {
      id: 4,
      title: "Cryptographic Protocols & TLS/SSL",
      description: "Implement TLS/SSL, PGP and secure communication protocols for web security",
      duration: "35 min",
      completed: false,
      type: "interactive",
      youtubeId: "S2iBR2ZlZfY",
      resources: ["TLS Handshake Analysis", "Certificate Authority Setup"]
    },
    {
      id: 5,
      title: "Quantum Cryptography & Post-Quantum",
      description: "Explore quantum-resistant algorithms and future-proof cryptographic techniques",
      duration: "32 min",
      completed: false,
      type: "video",
      youtubeId: "uiiaAJ3c6dM",
      resources: ["Quantum Key Distribution", "Post-Quantum Algorithms"]
    },
    {
      id: 6,
      title: "Cryptanalysis & Breaking Ciphers",
      description: "Learn cryptographic attacks, frequency analysis and cipher breaking techniques",
      duration: "40 min",
      completed: false,
      type: "interactive",
      youtubeId: "-yFZGF8FHSg",
      resources: ["Cryptanalysis Tools", "Attack Vectors Guide"]
    }
  ];

  const achievements = [
    { id: 1, name: "Encryption Master", description: "Complete symmetric encryption", earned: true, icon: Lock },
    { id: 2, name: "Public Key Expert", description: "Master asymmetric cryptography", earned: true, icon: Key },
    { id: 3, name: "Hash Specialist", description: "Understand hash functions", earned: false, icon: Hash },
    { id: 4, name: "Protocol Analyst", description: "Master cryptographic protocols", earned: false, icon: Shield },
    { id: 5, name: "Quantum Guardian", description: "Complete quantum cryptography", earned: false, icon: Zap },
    { id: 6, name: "Cryptography Pro", description: "Complete all course modules", earned: false, icon: Award }
  ];
  ...
  const handleDownloadAll = () => {
    try {
      const bundlePath = "/downloads/cryptography/hacking_zone_cryptography.zip";
      const link = document.createElement('a');
      ...
      alert('Unable to start bundle download. Make sure hacking_zone_cryptography.zip exists in /public/downloads/');
    }
  };
  ...
  // Certificate Generation for Cryptography
  const generateCertificate = () => {
    ...
    pdf.setFont(undefined, 'bold');
    const certNumber = 'CSA-CR' + Array.from({length: 8}, () => 
    ...
    pdf.setTextColor(0, 0, 0);
    pdf.setFont(undefined, 'bold');
    pdf.text('Cryptography & Encryption Specialist', pageWidth / 2, 100, { align: 'center' });
    ...
    const achievementLines = [
        ...
        'Cryptography & Encryption Specialist certification through examination'
    ];
    ...
    pdf.setTextColor(59, 130, 246);
    pdf.setFont(undefined, 'bold');
    pdf.text('Cryptography & Encryption', pageWidth / 2, 225, { align: 'center' });
    ...
    pdf.text('CRYPTOGRAPHY SPECIALIZATION', pageWidth / 2, accreditationY + 6, { align: 'center' });
    ...
    const fileName = `Cryptography_Certificate_${userData.firstName}_${userData.lastName}.pdf`;
    pdf.save(fileName);
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 flex-1">
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <h1 className="text-2xl md:text-4xl font-bold text-white mb-1">Cryptography & Encryption</h1>
                  <p className="text-blue-400 text-sm md:text-lg">Master encryption algorithms and protocols</p>
                </div>
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-blue-500/30"
              ...
              <div className="mt-3 md:mt-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
                  <h2 className="text-lg md:text-xl font-semibold text-white">Cryptography Essentials</h2>
                  <div className="flex items-center gap-2">
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Learn the mathematical foundations of cryptography and how encryption protects data in transit and at rest. 
                  Master symmetric and asymmetric algorithms, hash functions, digital signatures, and secure protocols.
                </p>
              </div>
            </motion.div>
              ...
              <motion.div className="space-y-4"
                ...
                <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
                  ...
                  <p className="text-gray-400 text-sm md:text-base mb-3 md:mb-4">
                    This comprehensive cryptography course covers both classical and modern encryption techniques, 
                    from basic ciphers to advanced encryption standards used in modern security systems. 
                    Learn to implement and break cryptographic systems like a professional.
                  </p>
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              placeholder="Take notes about encryption algorithms, hash functions, cryptographic protocols..."
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div className="flex justify-between">
                  ...
                  <span className="text-blue-400">Dr. Michael Zhang</span>
                </div>
                <div className="flex justify-between">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                🎓 Generate your professional Cryptography & Encryption certificate with official design, 
