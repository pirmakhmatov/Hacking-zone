...
import { ArrowLeft, Play, BookOpen, AlertTriangle, Zap, CheckCircle, Clock, Users, Target, Download, MessageCircle, Star, Bookmark, Share2, FileText, Award, Video, Code, FileDigit, Calendar, User, Save, Trash2, Cpu, Binary, Key, Lock, Sparkles, Search, Server, Terminal, Bug, FileSearch, Shield, Activity } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import jsPDF from "jspdf";

export default function IncidentResponse() {
  const [currentVideo, setCurrentVideo] = useState("LgAdXGntnnM");
  ...
  // Real downloadable files for Incident Response
  const resources = [
    { 
      ...
      icon: FileText, 
      downloads: 1780,
      fileUrl: "/downloads/incident-response/Incident-Response-Playbook.pdf",
      description: "Complete incident response procedures and checklists"
    },
    { 
      ...
      icon: Download, 
      downloads: 1120,
      fileUrl: "/downloads/incident-response/Digital-Forensics-Toolkit.zip",
      description: "Essential tools for digital forensics and evidence collection"
    },
    { 
      name: "IR Tabletop Exercises", 
      type: "PDF", 
      size: "2.9 MB", 
      icon: FileText, 
      downloads: 940,
      fileUrl: "/downloads/incident-response/IR-Tabletop-Exercises.pdf",
      description: "Real-world incident response scenarios and exercises"
    },
    { 
      name: "Malware Analysis Guide", 
      type: "PDF", 
      size: "3.2 MB", 
      icon: Bug, 
      downloads: 1260,
      fileUrl: "/downloads/incident-response/Malware-Analysis-Guide.pdf",
      description: "Malware analysis techniques for incident responders"
    },
    { 
      name: "Network Forensics Scripts", 
      type: "ZIP", 
      size: "5.7 MB", 
      icon: Code, 
      downloads: 780,
      fileUrl: "/downloads/incident-response/Network-Forensics-Scripts.zip",
      description: "Custom scripts for network traffic analysis and forensics"
    },
    { 
      name: "Incident Reporting Templates", 
      type: "ZIP", 
      size: "4.1 MB", 
      icon: FileText, 
      downloads: 1350,
      fileUrl: "/downloads/incident-response/Incident-Reporting-Templates.zip",
      description: "Professional incident reporting and documentation templates"
    }
  ];
  ...
  const lessons = [
    {
      ...
      description: "Learn the core principles of incident response and establish effective IR frameworks",
      duration: "30 min",
      completed: true,
      type: "video",
      youtubeId: "LgAdXGntnnM",
      resources: ["IR Framework", "Response Checklist"]
    },
    {
      id: 2,
      title: "Detection & Analysis",
      description: "Master threat detection techniques and incident analysis methodologies",
      duration: "35 min",
      completed: true,
      type: "interactive",
      youtubeId: "hofMDyQoilI",
      resources: ["Detection Tools", "Analysis Templates"]
    },
    {
      id: 3,
      title: "Containment & Eradication",
      description: "Learn effective containment strategies and complete threat eradication",
      duration: "28 min",
      completed: false,
      type: "video",
      youtubeId: "YqerC-0JUd4",
      resources: ["Containment Playbook", "Eradication Procedures"]
    },
    {
      id: 4,
      title: "Digital Forensics & Evidence",
      description: "Master digital forensics techniques and proper evidence handling",
      duration: "45 min",
      completed: false,
      type: "interactive",
      youtubeId: "-qF7uFTxlhI",
      resources: ["Forensics Tools", "Evidence Guide"]
    },
    {
      id: 5,
      title: "Recovery & Post-Incident",
      description: "System recovery procedures and post-incident activity analysis",
      duration: "32 min",
      completed: false,
      type: "video",
      youtubeId: "Zl9wmUUqxdI",
      resources: ["Recovery Plan", "Lessons Learned"]
    },
    {
      id: 6,
      title: "Advanced Threat Response",
      description: "Responding to advanced persistent threats and sophisticated attacks",
      duration: "40 min",
      completed: false,
      type: "interactive",
      youtubeId: "VNp35Uw_bSM",
      resources: ["APT Response", "Advanced Tools"]
    }
  ];

  const achievements = [
    { id: 1, name: "First Responder", description: "Complete IR fundamentals", earned: true, icon: AlertTriangle },
    { id: 2, name: "Threat Hunter", description: "Master detection techniques", earned: true, icon: Search },
    { id: 3, name: "Containment Expert", description: "Finish containment module", earned: false, icon: Shield },
    { id: 4, name: "Forensics Analyst", description: "Complete forensics training", earned: false, icon: FileSearch },
    { id: 5, name: "Recovery Specialist", description: "Master recovery procedures", earned: false, icon: Activity },
    { id: 6, name: "Incident Commander", description: "Complete all IR modules", earned: false, icon: Award }
  ];
  ...
  const handleDownloadAll = () => {
    try {
      const bundlePath = "/downloads/incident-response/hacking_zone_incident_response.zip";
      const link = document.createElement('a');
      ...
      alert('Unable to start bundle download. Make sure hacking_zone_incident_response.zip exists in /public/downloads/');
    }
  };
  ...
  // Certificate Generation for Incident Response
  const generateCertificate = () => {
    ...
    pdf.setFillColor(220, 38, 38); // Red theme
    ...
    pdf.setFont(undefined, 'bold');
    const certNumber = 'CSA-IR' + Array.from({length: 8}, () => 
    ...
    pdf.setTextColor(0, 0, 0);
    pdf.setFont(undefined, 'bold');
    pdf.text('Incident Response Specialist', pageWidth / 2, 100, { align: 'center' });
    ...
    const achievementLines = [
        ...
        'Incident Response Specialist certification through examination'
    ];
    ...
    pdf.setTextColor(220, 38, 38);
    pdf.setFont(undefined, 'bold');
    pdf.text('Incident Response & Digital Forensics', pageWidth / 2, 225, { align: 'center' });
    ...
    const skills = [
        ...
        '• Threat Detection & Analysis Methodologies',
        '• Containment & Eradication Strategies',
        '• Digital Forensics & Evidence Collection',
        '• System Recovery & Post-Incident Analysis',
        '• Advanced Threat Response Procedures'
    ];
    ...
    pdf.text('INCIDENT RESPONSE SPECIALIZATION', pageWidth / 2, accreditationY + 6, { align: 'center' });
    ...
    const fileName = `IncidentResponse_Certificate_${userData.firstName}_${userData.lastName}.pdf`;
    pdf.save(fileName);
  ...
  return (
    <div className="min-h-screen py-4 md:py-8 px-3 md:px-4 pt-20 md:pt-24">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-red-500/3 rounded-full blur-3xl"></div>
      </div>
      ...
      <motion.div className="max-w-7xl mx-auto relative z-10"
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6 md:mb-8">
          <Link to="/learning" className="glass card-cyber p-2 md:p-3 border border-red-500/30 hover:border-red-500/50 transition-colors self-start">
            <ArrowLeft className="w-4 h-4 md:w-5 md:h-5 text-red-400" />
          </Link>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 flex-1">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-red-500 to-orange-500 rounded-lg md:rounded-xl flex items-center justify-center">
              <AlertTriangle className="w-6 h-6 md:w-8 md:h-8 text-white" />
            </div>
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <h1 className="text-2xl md:text-4xl font-bold text-white mb-1">Incident Response</h1>
                  <p className="text-red-400 text-sm md:text-lg">Master cyber incident handling and forensics</p>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <motion.button
                    ...
                    className="glass p-2 border border-gray-700/50 rounded-lg text-gray-400 hover:text-red-400 transition-colors"
                  >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 md:gap-8">
          ...
          <div className="xl:col-span-3 space-y-4 md:space-y-6">
            {/* Video Player */}
            <motion.div className="glass card-cyber p-4 md:p-6 border border-red-500/30"
              ...
              <div className="mt-3 md:mt-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
                  <h2 className="text-lg md:text-xl font-semibold text-white">Cyber Incident Handling</h2>
                  <div className="flex items-center gap-2">
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Learn professional incident response methodologies, digital forensics techniques, and 
                  advanced threat handling procedures used by security operations centers worldwide.
                </p>
              </div>
            </motion.div>
              ...
              <motion.div className="space-y-4"
                ...
                <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
                  ...
                  <p className="text-gray-400 text-sm md:text-base mb-3 md:mb-4">
                    This comprehensive incident response course covers the complete lifecycle of cyber incident handling. 
                    From initial detection to post-incident analysis, you'll master the skills needed to respond effectively 
                        ...
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex items-start gap-3 flex-1">
                            {lesson.completed ? (
                              ...
                              <div className="w-5 h-5 rounded-full border-2 border-red-400 group-hover:border-red-300 transition-colors mt-0.5 flex-shrink-0"></div>
                            )}
                            <div className="flex-1">
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              placeholder="Take notes about incident response procedures, forensics techniques, or case studies..."
            ...
            {activeTab === "resources" && (
              <motion.div className="glass card-cyber p-4 md:p-6 border border-blue-500/30"
                ...
                <motion.button
                  ...
                  className="w-full mt-4 py-3 bg-gradient-to-r from-blue-500 to-red-500 text-white font-bold rounded-lg hover:from-blue-600 hover:to-red-600 transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                >
          ...
          <div className="xl:col-span-1 space-y-4 md:space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div className="p-2 bg-red-500/10 rounded border border-red-500/20">
                    <div className="text-red-400 font-bold text-lg">{completedLessons}/{totalLessons}</div>
                ...
                <motion.button
                  ...
                  className={`w-full py-2 md:py-3 font-bold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 text-sm md:text-base ${
                    progress >= 100
                      ? "bg-gradient-to-r from-green-500 to-red-500 text-white hover:from-green-600 hover:to-red-600 shadow-lg shadow-green-500/25"
                ...
                <button 
                  ...
                  className="w-full py-2 md:py-3 bg-gradient-to-r from-red-500 to-orange-500 text-white font-bold rounded-lg hover:from-red-600 hover:to-orange-600 transition-all duration-300 flex items-center justify-center gap-2 text-sm md:text-base"
                >
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-blue-500/30"
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button 
                  onClick={handleShareCourse}
                  className="p-3 bg-red-500/10 border border-red-500/20 rounded-lg text-red-400 hover:bg-red-500/20 transition-colors text-sm flex flex-col items-center gap-1"
                >
                  <Share2 className="w-4 h-4" />
                  <span>Share</span>
                </button>
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div className="flex justify-between">
                  ...
                  <span className="text-red-400">Mark Thompson</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span>Category:</span>
                  <span className="text-orange-400">Incident Response</span>
                </div>
                <div className="flex justify-between">
      ...
      {showShareOptions && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <motion.div 
            ...
            className="glass card-cyber p-6 border border-red-500/30 rounded-xl max-w-md w-full"
          >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                🎓 Generate your professional Incident Response certificate with official design, 
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-green-500 to-red-500 text-white font-bold rounded-lg hover:from-green-600 hover:to-red-600 transition-all duration-300 shadow-lg shadow-green-500/25 flex items-center justify-center gap-3"
                >
