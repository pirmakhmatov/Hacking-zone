...
import { ArrowLeft, Play, BookOpen, Shield, Zap, CheckCircle, Clock, Users, Target, Download, MessageCircle, Star, Bookmark, Share2, FileText, Award, Video, Code, FileDigit, Calendar, User, Save, Trash2, Cpu, Binary, Key, Lock, Sparkles, Wifi, Radio, Signal, Satellite } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import jsPDF from "jspdf";

export default function WirelessSecurity() {
  const [currentVideo, setCurrentVideo] = useState("Uz-RTurph3c");
  ...
  // Real downloadable files for Wireless Security
  const resources = [
    { 
      name: "Wireless Penetration Testing Guide", 
      type: "PDF", 
      size: "3.2 MB", 
      icon: FileText, 
      downloads: 980,
      fileUrl: "/downloads/wireless-security/Wireless-Penetration-Testing-Guide.pdf",
      description: "Complete guide to wireless network security testing methodologies"
    },
    { 
      name: "WiFi Security Tools Collection", 
      type: "ZIP", 
      size: "18.5 MB", 
      icon: Download, 
      downloads: 670,
      fileUrl: "/downloads/wireless-security/WiFi-Security-Tools-Collection.zip",
      description: "Essential tools for wireless security assessment and monitoring"
    },
    { 
      name: "WPA3 Security Implementation", 
      type: "PDF", 
      size: "2.1 MB", 
      icon: FileText, 
      downloads: 890,
      fileUrl: "/downloads/wireless-security/WPA3-Security-Implementation.pdf",
      description: "Comprehensive guide to WPA3 implementation and security"
    },
    { 
      ...
      icon: FileText, 
      downloads: 1200,
      fileUrl: "/downloads/wireless-security/Wireless-Attack-Vectors.pdf",
      description: "Detailed analysis of common wireless network attack methods"
    },
    { 
      ...
      icon: Radio, 
      downloads: 540,
      fileUrl: "/downloads/wireless-security/Bluetooth-Security-Assessment.zip",
      description: "Tools and techniques for Bluetooth security testing"
    },
    { 
      name: "RFID Security Research", 
      type: "PDF", 
      size: "2.8 MB", 
      icon: FileText, 
      downloads: 430,
      fileUrl: "/downloads/wireless-security/RFID-Security-Research.pdf",
      description: "Advanced RFID security vulnerabilities and protection"
    }
  ];
  ...
  const lessons = [
    {
      ...
      description: "Understanding WiFi protocols, frequencies, and network architecture",
      duration: "34 min",
      completed: true,
      type: "video",
      youtubeId: "Uz-RTurph3c",
      resources: ["Wireless Standards Chart", "Frequency Bands Guide"]
    },
    {
      id: 2,
      title: "WPA/WPA2 Cracking Techniques",
      description: "Hands-on techniques for assessing WPA/WPA2 security",
      duration: "25 min",
      completed: true,
      type: "interactive",
      youtubeId: "X49lIPHcurE",
      resources: ["Handshake Capture Guide", "Wordlist Collection"]
    },
    {
      id: 3,
      title: "WPA3 Security & Vulnerabilities",
      description: "Latest WPA3 protocol analysis and security assessment",
      duration: "22 min",
      completed: false,
      type: "video",
      youtubeId: "WZaIfyvERcA",
      resources: ["WPA3 Configuration Guide", "Security Checklist"]
    },
    {
      id: 4,
      title: "Enterprise Wireless Security",
      description: "Securing corporate wireless networks and RADIUS implementation",
      duration: "30 min",
      completed: false,
      type: "interactive",
      youtubeId: "wpfEWCBxMJg",
      resources: ["RADIUS Setup Guide", "Enterprise Security Template"]
    },
    {
      id: 5,
      title: "Bluetooth & IoT Device Security",
      description: "Assessing Bluetooth-enabled devices and IoT security",
      duration: "20 min",
      completed: false,
      type: "video",
      youtubeId: "TuUsF8Mf5W4",
      resources: ["Bluetooth Tools", "IoT Assessment Framework"]
    },
    {
      id: 6,
      title: "Wireless Intrusion Detection",
      description: "Implementing WIDS and monitoring wireless threats",
      duration: "28 min",
      completed: false,
      type: "interactive",
      youtubeId: "QavDORdwOf4",
      resources: ["WIDS Configuration", "Threat Detection Rules"]
    }
  ];

  const achievements = [
    { id: 1, name: "WiFi Analyst", description: "Complete Wireless Fundamentals", earned: true, icon: Wifi },
    { id: 2, name: "WPA Cracker", description: "Master WPA/WPA2 assessment", earned: true, icon: Key },
    { id: 3, name: "Enterprise Defender", description: "Finish Enterprise Security", earned: false, icon: Shield },
    { id: 4, name: "Wireless Guardian", description: "Complete all wireless modules", earned: false, icon: Award },
    { id: 5, name: "Bluetooth Expert", description: "Master Bluetooth security", earned: false, icon: Radio },
    { id: 6, name: "RF Specialist", description: "Complete RF security modules", earned: false, icon: Signal }
  ];
  ...
  const handleDownloadAll = () => {
    try {
      const bundlePath = "/downloads/wireless-security/hacking_zone_wireless_security.zip";
      const link = document.createElement('a');
      ...
      alert('Unable to start bundle download. Make sure hacking_zone_wireless_security.zip exists in /public/downloads/');
    }
  };
  ...
  // Certificate Generation for Wireless Security
  const generateCertificate = () => {
    ...
    pdf.setFont(undefined, 'bold');
    const certNumber = 'CSA-WS' + Array.from({length: 8}, () => 
    ...
    pdf.setTextColor(0, 0, 0);
    pdf.setFont(undefined, 'bold');
    pdf.text('Wireless Security Specialist', pageWidth / 2, 100, { align: 'center' });
    ...
    const achievementLines = [
        ...
        'Wireless Security Specialist certification through examination'
    ];
    ...
    pdf.setTextColor(234, 179, 8);
    pdf.setFont(undefined, 'bold');
    pdf.text('Wireless Security Fundamentals', pageWidth / 2, 225, { align: 'center' });
    ...
    pdf.text('WIRELESS SECURITY SPECIALIZATION', pageWidth / 2, accreditationY + 6, { align: 'center' });
    ...
    const fileName = `WirelessSecurity_Certificate_${userData.firstName}_${userData.lastName}.pdf`;
    pdf.save(fileName);
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 flex-1">
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <h1 className="text-2xl md:text-4xl font-bold text-white mb-1">Wireless Security</h1>
                  <p className="text-yellow-400 text-sm md:text-lg">Master WiFi, Bluetooth, and RF security</p>
                </div>
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-yellow-500/30"
              ...
              <div className="aspect-video bg-black rounded-lg overflow-hidden relative">
                <iframe
                  ...
                  title="Wireless Security Course"
                  frameBorder="0"
              ...
              <div className="mt-3 md:mt-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
                  <h2 className="text-lg md:text-xl font-semibold text-white">Wireless Network Security</h2>
                  <div className="flex items-center gap-2">
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Master wireless security assessment techniques including WiFi penetration testing, 
                  WPA/WPA2 cracking, enterprise wireless security, Bluetooth security, and RF analysis.
                </p>
              </div>
            </motion.div>
              ...
              <motion.div className="space-y-4"
                ...
                <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
                  ...
                  <p className="text-gray-400 text-sm md:text-base mb-3 md:mb-4">
                    This comprehensive wireless security course covers everything from basic WiFi protocols 
                    to advanced enterprise wireless security, Bluetooth exploitation, and RF security analysis. 
                    Learn both offensive and defensive wireless security techniques.
                  </p>
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              placeholder="Take notes about wireless protocols, security techniques, or assessment methods..."
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                  ...
                  <div className="p-2 bg-purple-500/10 rounded border border-purple-500/20">
                    <div className="text-purple-400 font-bold text-lg">{resources.length}</div>
                ...
                <motion.button
                  ...
                  className={`w-full py-2 md:py-3 font-bold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 text-sm md:text-base ${
                    progress >= 100
                      ? "bg-gradient-to-r from-green-500 to-yellow-500 text-white hover:from-green-600 hover:to-yellow-600 shadow-lg shadow-green-500/25"
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div className="flex justify-between">
                  ...
                  <span className="text-yellow-400">Dr. Sarah Chen</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span>Category:</span>
                  <span className="text-purple-400">Wireless Security</span>
                </div>
                <div className="flex justify-between">
      ...
      {showCertificateModal && (
        <div className="fixed inset-0 bg-black/95 flex items-center justify-center z-50 p-4">
          <motion.div 
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(234, 179, 8, 0.1) 0%, rgba(236, 72, 153, 0.1) 100%)'
            }}
          >
            {/* Animated background */}
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                🎓 Generate your professional Wireless Security certificate with official design, 
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-green-500 to-yellow-500 text-white font-bold rounded-lg hover:from-green-600 hover:to-yellow-600 transition-all duration-300 shadow-lg shadow-green-500/25 flex items-center justify-center gap-3"
                >
