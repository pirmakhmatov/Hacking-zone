// src/pages/Learning/courses/WebSecurity.jsx
  ...
  const lessons = [
    {
      ...
      description: "Understanding the basics of web application security"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Understanding and defending against XSS attacks"
    },
    {
      id: 4,
      ...
      description: "Preventing CSRF attacks in web applications"
    },
    {
      id: 5,
      title: "Hands-on Lab: Vulnerable Web App",
      duration: "30 min",
      type: "lab",
      completed: completedLessons.includes(5),
      description: "Practical exercise on a deliberately vulnerable application"
    }
  ];
  ...
  return (
    <div className="min-h-screen py-8 px-4 pt-24">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-cyan-500/3 rounded-full blur-3xl"></div>
      </div>
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        lesson.completed ? 'bg-green-500/20' : 'bg-cyan-500/20'
                      }`}>
                        {lesson.completed ? (
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400">{courseData.level}</span>
                </div>
                <div className="flex justify-between">
