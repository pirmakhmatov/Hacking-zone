...
import { ArrowLeft, Play, BookOpen, Cpu, Zap, CheckCircle, Clock, Users, Target, Download, MessageCircle, Star, Bookmark, Share2, FileText, Award, Video, Code, FileDigit, Calendar, User, Save, Trash2, Binary, Key, Lock, Sparkles, Bug, FileSearch, Microscope, Code2 } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import jsPDF from "jspdf";

export default function ReverseEngineering() {
  const [currentVideo, setCurrentVideo] = useState("gh2RXE9BIN8");
  ...
  // Real downloadable files for Reverse Engineering
  const resources = [
    { 
      name: "IDA Pro Complete Guide", 
      type: "PDF", 
      size: "4.2 MB", 
      icon: FileText, 
      downloads: 890,
      fileUrl: "/downloads/reverse-engineering/IDA-Pro-Complete-Guide.pdf",
      description: "Comprehensive guide to IDA Pro disassembler and advanced features"
    },
    { 
      name: "Reverse Engineering Tools Suite", 
      type: "ZIP", 
      size: "25.7 MB", 
      icon: Download, 
      downloads: 670,
      fileUrl: "/downloads/reverse-engineering/Reverse-Engineering-Tools-Suite.zip",
      description: "Collection of essential reverse engineering tools and utilities"
    },
    { 
      name: "x86/x64 Assembly Reference", 
      type: "PDF", 
      size: "2.8 MB", 
      icon: FileText, 
      downloads: 1200,
      fileUrl: "/downloads/reverse-engineering/x86-x64-Assembly-Reference.pdf",
      description: "Complete assembly language reference for reverse engineers"
    },
    { 
      ...
      icon: Code, 
      downloads: 540,
      fileUrl: "/downloads/reverse-engineering/Malware-Analysis-Toolkit.zip",
      description: "Tools and scripts for advanced malware analysis"
    }
  ];
  ...
  const lessons = [
    {
      ...
      description: "Learn to analyze executable files and understand assembly code, file formats, and basic reverse engineering concepts",
      duration: "30 min",
      completed: true,
      type: "video",
      youtubeId: "gh2RXE9BIN8",
      resources: ["PE File Structure", "Assembly Cheat Sheet"]
    },
    {
      id: 2,
      title: "Debugging with GDB & x64dbg",
      description: "Master debugging techniques, dynamic analysis, and runtime manipulation using industry-standard debuggers",
      duration: "35 min",
      completed: true,
      type: "interactive",
      youtubeId: "8RlKhDtBa9U",
      resources: ["GDB Commands", "x64dbg Scripts"]
    },
    {
      id: 3,
      title: "Malware Analysis & Reverse Engineering",
      description: "Analyze malicious software, understand attack vectors, and extract indicators of compromise",
      duration: "24 min",
      completed: false,
      type: "video",
      youtubeId: "XQQltImlksM",
      resources: ["YARA Rules", "Malware Analysis Template"]
    },
    {
      id: 4,
      title: "Advanced Reverse Engineering",
      description: "Code obfuscation, anti-analysis techniques, and advanced binary patching methods",
      duration: "45 min",
      completed: false,
      type: "interactive",
      youtubeId: "8vk5z9VAaBQ",
      resources: ["Obfuscation Techniques", "Binary Patching Guide"]
    }
  ];

  const achievements = [
    { id: 1, name: "Binary Analyst", description: "Complete binary analysis fundamentals", earned: true, icon: Binary },
    { id: 2, name: "Debugging Master", description: "Master debugging techniques", earned: true, icon: Bug },
    { id: 3, name: "Malware Researcher", description: "Finish malware analysis module", earned: false, icon: Microscope },
    { id: 4, name: "Reverse Engineering Expert", description: "Complete all advanced modules", earned: false, icon: Code2 }
  ];
  ...
  const handleDownloadAll = () => {
    try {
      const bundlePath = "/downloads/reverse-engineering/hacking_zone_reverse_engineering.zip";
      const link = document.createElement('a');
      ...
      alert('Unable to start bundle download. Make sure hacking_zone_reverse_engineering.zip exists in /public/downloads/');
    }
  };
  ...
  // Certificate Generation for Reverse Engineering
  const generateCertificate = () => {
    ...
    pdf.setFillColor(234, 88, 12); // Orange theme
    ...
    pdf.setFont(undefined, 'bold');
    const certNumber = 'CSA-RE' + Array.from({length: 8}, () => 
    ...
    pdf.setTextColor(0, 0, 0);
    pdf.setFont(undefined, 'bold');
    pdf.text('Reverse Engineering Specialist', pageWidth / 2, 100, { align: 'center' });
    ...
    const achievementLines = [
        ...
        'Reverse Engineering Specialist certification through examination'
    ];
    ...
    pdf.setTextColor(234, 88, 12);
    pdf.setFont(undefined, 'bold');
    pdf.text('Reverse Engineering Fundamentals', pageWidth / 2, 225, { align: 'center' });
    ...
    const skills = [
        '• Binary Analysis & File Format Understanding',
        '• Debugging with GDB & x64dbg',
        '• Assembly Language Comprehension',
        '• Malware Analysis Techniques',
        '• Code Obfuscation Recognition',
    ...
    pdf.text('REVERSE ENGINEERING SPECIALIZATION', pageWidth / 2, accreditationY + 6, { align: 'center' });
    ...
    const fileName = `ReverseEngineering_Certificate_${userData.firstName}_${userData.lastName}.pdf`;
    pdf.save(fileName);
    ...
    <div className="min-h-screen py-4 md:py-8 px-3 md:px-4 pt-20 md:pt-24">
      ...
      <motion.div className="max-w-7xl mx-auto relative z-10"
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6 md:mb-8">
          <Link to="/learning" className="glass card-cyber p-2 md:p-3 border border-orange-500/30 hover:border-orange-500/50 transition-colors self-start">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 flex-1">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg md:rounded-xl flex items-center justify-center">
              <Cpu className="w-6 h-6 md:w-8 md:h-8 text-white" />
            </div>
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
                  <h1 className="text-2xl md:text-4xl font-bold text-white mb-1">Reverse Engineering</h1>
                  <p className="text-orange-400 text-sm md:text-lg">Master binary analysis and debugging</p>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <motion.button
                    ...
                    className="glass p-2 border border-gray-700/50 rounded-lg text-gray-400 hover:text-orange-400 transition-colors"
                  >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 md:gap-8">
          ...
          <div className="xl:col-span-3 space-y-4 md:space-y-6">
            {/* Video Player */}
            <motion.div className="glass card-cyber p-4 md:p-6 border border-orange-500/30"
              ...
              <div className="mt-3 md:mt-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-2">
                  <h2 className="text-lg md:text-xl font-semibold text-white">Binary Analysis Introduction</h2>
                  <div className="flex items-center gap-2">
                ...
                <p className="text-gray-400 text-sm md:text-base">
                  Learn the fundamentals of reverse engineering, from basic binary analysis to advanced debugging techniques 
              ...
              <motion.div className="space-y-4"
                ...
                <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
                  ...
                  <p className="text-gray-400 text-sm md:text-base mb-3 md:mb-4">
                    ...
                    Master tools like IDA Pro, Ghidra, and advanced debugging techniques.
                  </p>
                ...
                <motion.div className="glass card-cyber p-4 md:p-6 border border-orange-500/30"
                  initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }}>
                  <h3 className="text-base md:text-lg font-semibold text-white mb-3 md:mb-4 flex items-center gap-2">
                    <Video className="w-4 h-4 md:w-5 md:h-5 text-orange-400" />
                        ...
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex items-start gap-3 flex-1">
                            {lesson.completed ? (
                              ...
                              <div className="w-5 h-5 rounded-full border-2 border-orange-400 group-hover:border-orange-300 transition-colors mt-0.5 flex-shrink-0"></div>
                            )}
                            <div className="flex-1">
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              placeholder="Take notes about assembly code, debugging techniques, or malware analysis..."
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div className="p-2 bg-orange-500/10 rounded border border-orange-500/20">
                    <div className="text-orange-400 font-bold text-lg">{completedLessons}/{totalLessons}</div>
                ...
                <motion.button
                  ...
                  className={`w-full py-2 md:py-3 font-bold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 text-sm md:text-base ${
                    progress >= 100
                      ? "bg-gradient-to-r from-green-500 to-orange-500 text-white hover:from-green-600 hover:to-orange-600 shadow-lg shadow-green-500/25"
                ...
                <button 
                  ...
                  className="w-full py-2 md:py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold rounded-lg hover:from-orange-600 hover:to-red-600 transition-all duration-300 flex items-center justify-center gap-2 text-sm md:text-base"
                >
            ...
            <motion.div className="glass card-cyber p-4 md:p-6 border border-gray-700/50"
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <div className="flex justify-between">
                  ...
                  <span className="text-orange-400">Dr. Maria Rodriguez</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span>Category:</span>
                  <span className="text-purple-400">Reverse Engineering</span>
                </div>
                <div className="flex justify-between">
      ...
      {showShareOptions && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <motion.div 
            ...
            className="glass card-cyber p-6 border border-orange-500/30 rounded-xl max-w-md w-full"
          >
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-orange-500/20 text-orange-400 rounded-lg hover:bg-orange-500/30 transition-colors font-medium"
              >
                Copy Link
              </button>
              <button
        ...
        <div className="fixed inset-0 bg-black/95 flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <div className="absolute inset-0 opacity-5">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-red-500/20 animate-pulse"></div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                🎓 Generate your professional Reverse Engineering certificate with official design, 
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 bg-gradient-to-r from-green-500 to-orange-500 text-white font-bold rounded-lg hover:from-green-600 hover:to-orange-600 transition-all duration-300 shadow-lg shadow-green-500/25 flex items-center justify-center gap-3"
                >
